...
<?php else: ?>
	<div class="row catalog-list" id="products-list-container">
<?php endif ?>

	{{#each products}}
		<div class="product-preview-block-{{product_id}} col-lg-12">
			<!-- Image -->
			<div class="img-holder col-lg-3 col-md-3 col-sm-2">
			...
			<div class="pull-left title-container col-lg-6 col-md-6 col-sm-6">
				...
				<!-- Description -->
				<p class="visible-lg visible-md">{{description}}</p>
			...
			<!-- Price container -->
			<div class="price-container col-lg-3 col-md-3 col-sm-4">
				<!-- Prices -->
				<span class="actual-price pR">
					{{#if price }}
						<div class="price">
