      ...
      <div class="form-group" style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;">
        ...
        <div class="radio">
          <label for="customer_group_id-1" class="checked">
            <input type="radio" name="customer_group_id" id="customer_group_id-1" value="<?php echo $customer_group['customer_group_id']; ?>" checked="checked" />
        ...
        <div class="radio">
          <label for="customer_group_id-2">
            <input type="radio" name="customer_group_id" id="customer_group_id-2" value="<?php echo $customer_group['customer_group_id']; ?>" />
            <?php echo $customer_group['name']; ?>
          </label>
        </div>
        <?php } ?>
...
<div class="buttons clearfix">
  <div class="checkbox">
    <label for="agree-3">
      <input type="checkbox" name="agree" id="agree-3" value="1" />
      <?php echo $text_agree; ?>
    </label>
  </div>
