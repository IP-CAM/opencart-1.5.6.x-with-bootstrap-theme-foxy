<form class="form-horizontal">
  <?php if ($addresses) { ?>
  <div class="radio">
    <label for="payment_address-1" class="checked">
      <input type="radio" id="payment_address-1" name="payment_address" value="existing" checked="checked" />
  ...
  <div class="radio">
    <label for="payment_address-2">
      <input type="radio" id="payment_address-2" name="payment_address" value="new" />
